...
import { AlertTriangleIcon, FileTextIcon, UsersIcon, BarChartIcon } from "lucide-react";
...
export default async function AdminDashboard() {
  ...
  return (
    ...
    {passwordNeverChanged ? (
      ...
      <div className="grid gap-4 sm:grid-cols-1 lg:grid-cols-2 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150">
        <Card className="border-border/50 shadow-sm hover:shadow-md transition-all hover:border-border duration-300">
          <CardHeader>
        ...
        <Card className="border-border/50 shadow-sm hover:shadow-md transition-all hover:border-border duration-300 lg:col-span-2">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
